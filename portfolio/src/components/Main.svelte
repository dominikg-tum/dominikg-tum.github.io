...
<main class="flex flex-col flex-1 p-4">
	<section id="introPage" class="grid grid-cols-1 lg:grid-cols2 gap-10 py-8 sm:py-14">
		<div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
			<h2 class="font-semibold text-4xl sm:text-5xö md:text-6xl lg:text-7xl">
				Hi! I'm <span class="poppins text-violet-400">Dominik</span> Garstenauer, 
                <br /> a B.Sc. in <span class="poppins text-violet-400">Computer Science :)</span> 
			</h2>
