...
const Main = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<main class="flex flex-col flex-1 p-4"> <section id="introPage" class="grid grid-cols-1 lg:grid-cols2 gap-6 py-8 sm:py-4" data-svelte-h="svelte-f95dxf"><div class="flex flex-col lg:justify-center text-center gap-6 md:gap-8 lg:gap-10"><h2 class="font-semibold text-5xl sm:text-5xl md:text-6xl lg:text-7xl">Hi <span class="wave">👋</span></h2> <h3 class="font-semibold text-4xl sm:text-4xl md:text-5xl lg:text-6xl">I&#39;m <span class="poppins text-violet-400">Dominik</span>
    ...
    default: () => {
      return `<p data-svelte-h="svelte-1cg9qwq">Bla Bla Bla bla bla bla <strong class="text-violet-400">Bla bla Bla!</strong> Cla cla cla cla.</p>`;
    }
