...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header${add_attribute(
    ...
    0
  )}><h1 class="font-medium" data-svelte-h="svelte-29xoh9"><b class="font-bold poppins">Dominik</b> Garstenauer</h1> <div class="sm:flex items-center gap-4 hidden">${each(tabs, (tab, index) => {
